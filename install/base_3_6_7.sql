...
(3, 'Аренда интернет-магазина', '', 'Shopbuilder - это SaaS сервис аренды интернет-магазина PHPShop, позволяющий пользователям за считанные минуты создать полноценный сайт интернет-магазина за 599 руб.', 'http://www.shopbuilder.ru', 1, '1');
...
(1, 'Программирование', 'Быстрая доработка под ваши нужды. Адаптировать скрипт под вас можем как мы, так и любой грамотный программист, с помощью нашего IDE с подсказками переменных.\r\n', '1', 2, '', '0'),
(2, 'Обновления', 'Постоянное обновление функционала - cкрипт PHPShop постоянно развивается, вы получаете все преимущества обновлений, находясь на активной техподдержке.', '1', 4, '/', '0'),
(3, 'Личный менеджер', 'Личный менеджер проекта при заказе дизайна интернет-магазина, вам не придется разбираться в тонкостях верстки, программирования - эту работу выполняет личный менеджер проекта.\r\n', '1', 2, '/', '1'),
(4, 'Cкидки и бонусы', 'Накопительные скидки и бонусы - вы можете сэкономить, получив 10% от покупок приведенных друзей. Также действуют накопительные скидки, которые суммируются с бонусами.\r\n', '1', 3, '', '1');
...
(2, 'Администрирование', 'admin', 1000, '', '', 'Для доступа к панели управления PHPShop нажмите сочетание клавиш <b>Ctrl+F12</b> или используйте кнопку перехода ниже.<br> \r\nЛогин по умолчанию <b>demo</b>, пароль <b>demouser</b>. <br> \r\nЕсли вы при установке задали свой логин и пароль, то используйте свои данные при авторизации.\r\n<p>\r\n<input type="button" value="Переход в панель управления" onclick="window.location.replace(''..phpshop/admpanel/'');">\r\n</p>\r\n<p>\r\n<h2>Тестовая база</h2>\r\nПри установке магазина заполняется тестовая товарная база для демонстрации возможностей программы. Для очистки тестовой базы следует в панели управления магазином перейти в меню <b>"База" - "SQL запрос к базе"</b>и выбрать в выпадающем списке опцию <b>"Очистить базу"</b>. Обращаем Ваше внимание, что очистится вся товарная база с момента начала работы магазина.\r\n</p>\r\n<p>\r\n<h2>Дополнительные утилиты</h2>\r\nPHPShop EasyControl - <b>уникальный набор  бесплатных утилит</b> для создания и управления интернет-магазином PHPShop на локальном компьютере . EasyControl прост в установке и не требует никаких специальных навыков. С помощью EasyControl Вы сможете установить сайт локально на ПК либо на хостинг, обновлять платформу сайта, обрабатывать заказы, заполнять товарную базу и редактировать шаблоны. В состав пакета входят 20 утилит: <b>Order Agent, Monitor, Updater, Installer, Chat,  Price Loader, Editor, IDE, Password Restore</b> и другие.\r\n</p>\r\n<p>\r\n<input type="button" value="Скачать утилиты EasyControl" onclick="window.open(''http://www.phpshop.ru/loads/files/setup.exe'');">\r\n</p>\r\n\r\n', '', 1, 1323776456, '', 'Администрирование PHPShop', '1', '', ''),
(3, 'Разработчикам', 'develop', 1000, '', '', 'В помощь разработчикам PHPShop Software разработала специально интегрированную среду разработки <b>PHPShop IDE</b> и визуальный редактор шаблонов <b>PHPShop Editor</b>.\r\n<h3>PHPShop IDE</h3>\r\n<p>PHPShop IDE обладает большими возможностями и ускоряет процесс редактирования кода, ориентированна на широкий круг пользователей от новичков до профессионалов.\r\n<p>\r\n<b>Возможности:</b>\r\n<ol>\r\n<li class="trial">Подсвет и редактирование встроенных функций PHPShop API\r\n<li>Парсинг и возможность редактирования добавления методов через окна настроек\r\n<li>Быстрый доступ к часто используемым HTML и PHP функциям\r\n<li>Автоматическое создание новых модулей и библиотек\r\n<li>Добавление новых возможностей через внешний XML-файл настроек\r\n<li>Редактирование шаблонов дизайна\r\n<li>Форматирование и выравнивание кода\r\n<li>Создание закладок в коде для быстрого доступа к участкам кода \r\n</ol>\r\n</p>\r\n<p>\r\n<a href="http://wiki.phpshop.ru/index.php/PHPShop_IDE" target="_blank" title="Инструкция PHPShop IDE"><img class="template" src="/UserFiles/Image/Trial/phpshop_ide.jpg" alt="PHPShop IDE" width="95%"></a>\r\n</p>\r\n<h3>PHPShop Editor</h3>\r\n<p>\r\nPHPShop Editor позволяет самостоятельно менять местами блоки, убирать ненужные элементы дизайна, управлять всеми доступными внутренними переменными шаблонизатора в визуальном режиме. \r\n</p>\r\n<p>\r\n<b>Режим визуального управления и редактирования</b> позволяет менять местами и управлять кодом внутренних блоков дизайна: опросами, баннерами, каталогами и т.д. Блоки можно перемещать в любое место, удалять из шаблона. Поддерживается режим HTML-редактора кода для выбранного блока. \r\n</p>\r\n<b>Мастер оформления</b>  дает возможность через визуальные средства менять цветовые стили оформления CSS: подложка, цвета, шрифт, кнопки, селекты, ссылки элементов дизайна.\r\n</p>\r\n<p>\r\n<b>Режим правки HTML кода</b>  служит для изменения кода шаблона и помогает ориентироваться настройке шаблона. В режим можно попасть, нажав правой кнопкой мыши на нужном блоке и выбрав в меню опцию редактирования. Все элементы изображены в виде дерева файлов с описанием содержания файлов шаблонов. Для каждого шаблона выводятся доступные переменные с описанием для использования в шаблоне.\r\n</p>\r\n<p>\r\n<a href="http://wiki.phpshop.ru/index.php/PHPShop_Editor" target="_blank" title="Инструкция PHPShop Editor"><img  class="template" src="/UserFiles/Image/Trial/phpshop_editor.jpg" alt="PHPShop Editor" width="95%"></a>\r\n</p>\r\n<p>\r\n<b>Более 20 бесплатных утилит для работы с PHPShop</b> собраны в пакет <a href="http://wiki.phpshop.ru/index.php/PHPShop_EasyControl" target="_blank" title="Описание ути лит EasyControl">EasyControl</a> и доступны для загрузки на сайте разработчика в разделе <a href="http://phpshop.ru/page/downloads.html" target="_blank" title="Центр загрузки PHPShop">Центр загрузки</a>.</p>', '', 3, 1323776453, '', 'Разработчикам PHPShop', '1', '', ''),
(4, 'Купить', 'purchase', 1000, '', '', 'Ваш тестовый интернет-магазин  <b>@serverShop@</b> на базе платформы PHPShop Enterprise @version@ будет работать не более 30 дней. <b>Вы можете уже сейчас наполнять свой магазин, все данные после покупки сохранятся!</b><div><br></div><div>Купив <b>пожизненную лицензию PHPShop</b>, вам потребуется <b>загрузить лишь один файл лицензии</b>, а вся заполненная товарная база останется нетронутой.\r\n\r\n<p>Для приобретения программного обеспечения PHPShop, нужно перейти в раздел оформления заказа по кнопке ниже. Далее, вам нужно выбрать удобный тип оплаты - электронный: картами Visa, Mastercard, через банкоматы Qiwi, через Сбербанк, банковским переводом для юридических лиц, либо наличными: курьеру по Москве или в офисе. После выбора оплаты, в разделе Счета появится счет на оплату в электронном виде. Оригиналы всех документов мы отправляем по почте, указанной в разделе Профиль вашего личного кабинета. </p>\r\n\r\n<p><form method="post" target="_blank" enctype="multipart/form-data" action="http://www.phpshop.ru/order.html"  name="product_license" id="product_license">\r\n <input type="hidden" value="scriptenterprise" name="addToCartFromPages" id="addToCartFromPages">             \r\n  <input type="hidden" value="@serverShop@" name="addToCartFromPagesDomen" id="addToCartFromPagesDomen">\r\n<input type="button" value="Перейти к оформлению заказа PHPShop" onclick="document.product_license.submit()">\r\n</form>\r\n</p>\r\n\r\n<h2>Консультации</h2>\r\n<p>Мы будем рады видеть вас у нас в офисе с понедельника по пятницу с 10:00 до 19:00! Не забудьте предупредить нас о встрече по телефону:</p><p>\r\n8-800-700-11-15 бесплатный номер для регионов РФ,<br>8 (495) 989-11-15 для Москвы.</p><p>Адрес: Рязанский проспект, д. 24 корп. 2, 2 этаж, офис 3., м. Рязанский проспект. Бизнес-центр "Юнион-Центр". </p>\r\n\r\n<p><iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.google.ru/maps?f=q&source=s_q&hl=ru&geocode=FbEtUgMdgq5AAg%3BFaQ8UgMdCWhAAiGO9hUAe8ehdCm1mSQod7VKQTGO9hUAe8ehdA&q=%D0%A0%D1%8F%D0%B7%D0%B0%D0%BD%D1%81%D0%BA%D0%B8%D0%B9+%D0%BF%D1%80%D0%BE%D1%81%D0%BF.,+24+%D0%BA%D0%BE%D1%80%D0%BF%D1%83%D1%81+2,+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&aq=1&oq=%D1%80%D1%8F%D0%B7%D0%B0%D0%BD%D1%81%D0%BA%D0%B8%D0%B9+%D0%BF%D1%80%D0%BE%D1%81%D0%BF%D0%B5%D0%BA%D1%82+&sll=55.720729,37.774676&sspn=0.004061,0.011362&ie=UTF8&hq=&hnear=%D0%A0%D1%8F%D0%B7%D0%B0%D0%BD%D1%81%D0%BA%D0%B8%D0%B9+%D0%BF%D1%80%D0%BE%D1%81%D0%BF.,+24+%D0%BA%D0%BE%D1%80%D0%BF%D1%83%D1%81+2,+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0,+%D0%B3%D0%BE%D1%80%D0%BE%D0%B4+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&t=m&start=0&ll=55.725805,37.774343&spn=0.016918,0.036478&z=14&iwloc=A&output=embed"></iframe><br><small><a href="https://www.google.ru/maps?f=q&source=embed&hl=ru&geocode=FbEtUgMdgq5AAg%3BFaQ8UgMdCWhAAiGO9hUAe8ehdCm1mSQod7VKQTGO9hUAe8ehdA&q=%D0%A0%D1%8F%D0%B7%D0%B0%D0%BD%D1%81%D0%BA%D0%B8%D0%B9+%D0%BF%D1%80%D0%BE%D1%81%D0%BF.,+24+%D0%BA%D0%BE%D1%80%D0%BF%D1%83%D1%81+2,+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&aq=1&oq=%D1%80%D1%8F%D0%B7%D0%B0%D0%BD%D1%81%D0%BA%D0%B8%D0%B9+%D0%BF%D1%80%D0%BE%D1%81%D0%BF%D0%B5%D0%BA%D1%82+&sll=55.720729,37.774676&sspn=0.004061,0.011362&ie=UTF8&hq=&hnear=%D0%A0%D1%8F%D0%B7%D0%B0%D0%BD%D1%81%D0%BA%D0%B8%D0%B9+%D0%BF%D1%80%D0%BE%D1%81%D0%BF.,+24+%D0%BA%D0%BE%D1%80%D0%BF%D1%83%D1%81+2,+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0,+%D0%B3%D0%BE%D1%80%D0%BE%D0%B4+%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0&t=m&start=0&ll=55.725805,37.774343&spn=0.016918,0.036478&z=14&iwloc=A" style="color:#0000FF;text-align:left" target="_blank">Просмотреть увеличенную карту</a></small></p>', '', 4, 1323776450, '', 'Купить PHPShop', '1', '', ''),
(1, 'PHPShop Enterprise @version@', 'index', 2000, '', '', '<p><img src="/UserFiles/Image/Trial/box.png" align="left" hspace="5" alt="PHPShop">В течение 10 лет PHPShop создает интернет-магазины с разумной ценой и хорошей репутацией, учитывая реальные запросы пользователей. С каждым годом PHPShop совершенствуется, чтобы стать еще более функциональным и гибким под каждый конкретный проект.</p>\r\n\r\nPHPShop - это <b>готовое коробочное решение</b> с возможностью легкого аддаптирования  под ваши нужды. Запуск готового решения обойдется <b>дешевле и быстрее</b>. \r\n\r\n', '', 0, 1321534107, '', '', '1', '', ''),
(5, 'Ресурсы', 'help', 1, '', '', '<h3>Справка</h3>\r\nСправочно-информационный сайт (F.A.Q.),  описывающий возможности PHPShop и ответы на частые вопросы по управлению интернет-магазином. Снабжен большим количеством скриншотов и видео-уроков.<br>\r\nАдрес: <a href="http://faq.phpshop.ru" target="_blank">faq.phpshop.ru</a>\r\n\r\n<h3>Техническая документация</h3>\r\nСправочный сайт для разработчиков (WIKI). Содержит большое количество технической документации с примерами по разработке PHPShop. Описание утилит EasyControl и дополнительных модулей.<br>\r\nАдрес: <a href="http://wiki.phpshop.ru" target="_blank">wiki.phpshop.ru</a>\r\n\r\n<h3>Описание API</h3>\r\nСправочный сайт для разработчиков (PHPDoc). Содержит подробное описание API PHPShop, функций и классов.<br>\r\nАдрес: <a href="http://doc.phpshop.ru" target="_blank">doc.phpshop.ru</a>\r\n\r\n<h3>База знаний</h3>\r\nСправочный сайт службы технической поддержки. Содержит ответы по наиболее частым вопросам, встречающихся у пользователей PHPShop в поддержке.<br>\r\nАдрес: <a href="https://help.phpshop.ru" target="_blank">help.phpshop.ru</a>\r\n\r\n<h3>Блог</h3>\r\nПерсональный блог PHPShop на портале Хабр. Содержит много интересных статей по возможностям платформы.<br>\r\nАдрес: <a href="http://habrahabr.ru/companyphpshop/blog/" target="_blank">http://habrahabr.ru/companyphpshop/blog/</a>\r\n\r\n<h3>Социальные сети</h3>\r\nПерсональные странички в популярных социальный сетях. Содержат много интересных публикаций по возможностям платформы, новостях и акциям.<br>\r\nАдрес: <a href="https://www.facebook.com/shopsoft" target="_blank">https://www.facebook.com/shopsoft</a><br>\r\n<a href="https://twitter.com/PHPShopCMS" target="_blank">https://twitter.com/PHPShopCMS</a><br>\r\n<a href="https://plus.google.com/+PhpshopRu" target="_blank">https://plus.google.com/+PhpshopRu</a>\r\n\r\n<h3>Видео-уроки</h3>\r\nИнформационный портал с видео-уроками по работе с PHPShop на портале YouTube. Содержат подробные уроки по настройки и работе с 1С-Синхронизацией, PHPShop и утилитами EasyControl.<br>\r\nАдрес: <a href="http://www.youtube.com/user/phpshopsoftware" target="_blank">http://www.youtube.com/user/phpshopsoftware</a>', '1', 1, 0, '', '', '1', '0', ''),
(6, 'Дизайн', 'design', 1000, '', '', '<p>В комплекте с PHPShop при установке, в архиве идут только 10 дизайнов для интернет-магазина. Остальные доступные дизайны можно скачать отдельно, как через модуль <a href="http://faq.phpshop.ru/page/template-edit.html" target="_blank">Template Edit</a>, так и по скриншотам ниже. Скачанный архив с шаблоном следует распаковать в папку phpshop/templates/.</p>\r\n</p> \r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_8" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_8.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_7" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_7.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_6" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_6.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_5" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_5.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_4" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_4.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_3" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_3.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_2" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_2.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="phpshop_1" class="template" src="/UserFiles/Image/Trial/template_icon/phpshop_1.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="aeroblue" class="template" src="/UserFiles/Image/Trial/template_icon/aeroblue.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="grass" class="template" src="/UserFiles/Image/Trial/template_icon/grass.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="grey" class="template" src="/UserFiles/Image/Trial/template_icon/grey.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="pink" class="template" src="/UserFiles/Image/Trial/template_icon/pink.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="blue_classic" class="template" src="/UserFiles/Image/Trial/template_icon/blue_classic.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="green_classic" class="template" src="/UserFiles/Image/Trial/template_icon/green_classic.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="red_classic" class="template" src="/UserFiles/Image/Trial/template_icon/red_classic.gif" width="150" height="120">\r\n<img onclick="window.open(''http://template.phpshop.ru/templates/''+this.title+''/''+this.title+''.zip'')" title="yellow_classic" class="template" src="/UserFiles/Image/Trial/template_icon/yellow_classic.gif" width="150" height="120">\r\n\r\n<h2>Изменение дизайна</h2>\r\nДля изменения дизайна на сервере, используется <b>специализированный модуль</b> Template Edit.\r\n<p><a href="http://faq.phpshop.ru/page/template-edit.html" target="_blank" title="Инструкция Template Edit"><img  class="template" src="/UserFiles/Image/Trial/template_edit.jpg" width="95%"></a><p>\r\nДля редактирования дизайна на локальном компьютере под управлением Windows существует <b>визуальный редактор</b> шаблонов PHPShop Editor.\r\n<p><a href="http://faq.phpshop.ru/page/your-design.html" target="_blank" title="Инструкция PHPShop Editor"><img  class="template" src="/UserFiles/Image/Trial/phpshop_editor.jpg" alt="PHPShop Editor" width="95%"></a></p>', '1', 2, 0, '', 'Дополнительные шаблоны PHPShop', '1', '0', '');
...
(5, 'Visa, Mastercard, Webmoney, Yandex (ROBOXchange)', 'robox', '1', 0, 'Ваш заказ оплачен', 'Ваш заказ оплачен'),
...
(9, 'Visa, Mastercard, Webmoney, Yandex (PayAnyWay)', 'payanyway', '1', 0, 'Ваш заказ оплачен', 'Ваш заказ оплачен');
...
INSERT INTO `phpshop_rssgraber` VALUES (1, 'http://www.phpshop.ru/rss.php', 1, 10, '1', 1307995200, 1554305600, 1322686800);

...
INSERT INTO `phpshop_page` VALUES (15, 'Как войти в админпанель?', 'page15', 1, '', '', 'С главной страницы сайта нажмите Ctrl+F12, загрузится страница админки, - осталось только ввести пароли, указанные при установке. На нашей демо-версии они будут уже заполнены: demo и demouser.<div><br></div><div><img src="/UserFiles/Image/Trial/str2.png" alt="" align="" border="0px"></div>\r\n\r\n\r\n\r\n\r\n', '', 1, 1323769257, '', '', '1', '', '');
...
INSERT INTO `phpshop_valuta` VALUES (4, 'Гривны', 'гр.', 'UAG', '0.06', 4, '1');

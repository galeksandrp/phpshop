...
INSERT INTO `phpshop_payment_systems` VALUES (1, 'Счет в банк', 'bank', '1', 0, 'Наши менеджеры свяжутся с вами. Счет доступен в личном кабинете.', 'ВАШ ЗАКАЗ УСПЕШНО ОФОРМЛЕН');
INSERT INTO `phpshop_payment_systems` VALUES (2, 'Квитанция Сбербанка', 'sberbank', '1', 0, 'Квитанция Сбербанка доступная в личном кабинете.', 'ВАШ ЗАКАЗ УСПЕШНО ОФОРМЛЕН');
INSERT INTO `phpshop_payment_systems` VALUES (3, 'Наличная оплата', 'message', '1', 0, 'В ближайшее время с вами свяжется наш менеджер.', 'ВАШ ЗАКАЗ УСПЕШНО ОФОРМЛЕН ');
INSERT INTO `phpshop_payment_systems` VALUES (4, 'Visa, Mastercard (PayOnlineSystem)', 'payonlinesystem', '1', 0, 'Спасибо за покупку', 'Ваш заказ оплачен');
INSERT INTO `phpshop_payment_systems` VALUES (5, 'WebMoney, Yandex Money (ROBOXchange)', 'robox', '1', 0, 'Ваш заказ оплачен', 'Ваш заказ оплачен');
INSERT INTO `phpshop_payment_systems` VALUES (6, 'WebMoney', 'webmoney', '1', 0, 'Ваш заказ оплачен', 'Ваш заказ оплачен');
...
-- 
-- Дамп данных таблицы `phpshop_bigcsv`
-- 

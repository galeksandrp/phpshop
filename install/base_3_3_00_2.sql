...
(1, 'Дизайн-бюро PHPShop', '<A title=\\\"Акция! 10% скидка на персональный дизайн\\\" href=\\\"http://www.phpshop.ru/docs/service.html#1\\\"><IMG border=0 alt=\\\"\\\" src=\\\"/UserFiles/Image/Trial/banner_skidka1.gif\\\" width=468 height=60></A>', 472092, 1931, '0', '30.06.10', 2147483647, '');
...
INSERT INTO `phpshop_rssgraber` VALUES
(1, 'http://www.phpshop.ru/rss.php', 1, 10, '1', 1225227600, 1330722000, 1278964800);

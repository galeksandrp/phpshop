...
ЛИЦЕНЗИОННОЕ СОГЛАШЕНИЕ НА ИСПОЛЬЗОВАНИЕ ПРОГРАММНОГО ПРОДУКТА "PHPShop"
        ...
        3.1. Пользователь имеет право бесплатно воспользоваться демо-версией Продукта, скачав с сайта Лицензиара www.phpshop.ru и установив на сервер в течении 45 дней, и без ограничений времени при установке на локальном компьютере. Демо-версии всех версий Продукта PHPShop работают без каких-либо ограничений функциональности, кроме количества выгрузки товаров в обработчике 1С версии PHPShop Enterprise Pro.
        ...
        3.5. Для официальных партнеров, после письменного согласования с Автором, ссылка размещается в удобном для них месте, на каждой странице сайта. Лицензия без копирайтов Автора увеличивает стоимость Продукта на 5600 руб.
        ...
        5.5. По истечению срока бесплатной технической поддержки, Пользователь может приобрести продление. Срок действия технической поддержки продлевается на один год с момента оплаты продления. Пользователь также получает возможность загрузить и установить все изменения и обновления, которые были выпущены к программному продукту до момента оплаты продления технической поддержки. Действующий прайс-лист для приобретения технической поддержки указан на интернет-сайте http://www.phpshop.ru/docs/techpod.html.
        ...
        5.7. Персональные доработки и модули, выполненные под заказ, поддерживаются бесплатно в течении 1 месяца. Дальнейшая поддержка по тарифам, указанным по адресу: http://phpshop.ru/docs/techpod.html.
            ...
            <TR class=adm vAlign=top align=middle>
                <TD align=left>
                    <FIELDSET id=fldLayout><LEGEND id=lgdLayout><u>Т</u>ест системных требований</LEGEND>
                        <DIV style="margin:10px;padding: 10px;background-color: #FFFFFF;">
                            <ol>
                                <li id="line1" style="visibility:hidden"> Apache <?= $API ?></li>
                                <li id="line2" style="visibility:hidden"> MySQL <?= $mysql ?>
                                <li id="line3" style="visibility:hidden"> PHP  <?= $php ?></li>

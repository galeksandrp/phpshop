<table width="100%"  border="0" cellpadding="0" cellspacing="5" style="">
  ...
  <tr>
    <td width="100%" height="70" align="left" valign="top"><A href="/shop/UID_@productUid@.html" class="product_name"  title="@productName@"><img src="@productImg@" alt="@productName@" title="@productName@" lowsrc="images/shop/no_photo.gif"  onerror="NoFoto(this,'@pathTemplate@')" onload="EditFoto(this,@productImgWidth@)"  border="0" align="left" hspace="5"></A>@productDes@<br />
<br />

...
<TABLE>
		...
		<TR>
		<TD width="100"  height="21" align="right" valign="top" style="background:url(images/price_bg.gif) top left no-repeat;  padding-top:3px;padding-left:13px;">
		<span class="price">@productPrice@ @productValutaName@</span><br>

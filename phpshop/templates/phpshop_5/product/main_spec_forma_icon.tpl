<table width="100%"  border="0" cellpadding="0" cellspacing="5" style="">
  ...
  <tr>
    <td width="100%" height="70" align="left" valign="top"><table cellpadding="0" cellspacing="0" border="0" align="left"><tr><td><A class=highslide onclick="return hs.expand(this)" href="@productImgBigFoto@" target=_blank getParams="null" title="@productName@"><img src="@productImg@" alt="@productName@" title="@productName@" lowsrc="images/shop/no_photo.gif"  onerror="NoFoto(this,'@pathTemplate@')" onload="EditFoto(this,@productImgWidth@)"  border="0" align="left" hspace="5"></A><div class=highslide-caption>@productName@</div></td></tr></table>@productDes@<br />
<br />
<img src="images/icons/i.gif" alt="i" width="14" height="14" align="top">&nbsp;<A href="/shop/UID_@productUid@.html" class="product_name"  title="@productName@"><u>Подробно</u></A></td>
  </tr>
  <tr>

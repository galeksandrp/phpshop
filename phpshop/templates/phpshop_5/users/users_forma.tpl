...
<table width="238" height="84" border="0">
  ...
  <tr>
  	<td>&nbsp;</td>
    <td colspan="3"><input type="text" value="@UserPassword@" name="password" class="topInputText" style="width:133px" /></td>
    <td><a href="/users/sendpassword.html"><u>Забыли пароль?</u></a></td>
  </tr>
  <tr>
  	<td>&nbsp;</td>
    <td width="15" align="left"><input type="checkbox" value="1" name="safe_users" /></td>

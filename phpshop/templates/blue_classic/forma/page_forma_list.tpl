<form method="post" name="forma_message">
    <table width="100%" cellpadding="5" class="forma_message">
        ...
        <tr>
            <td width="30%">Тема:&nbsp;&nbsp;&nbsp; </td>
            <td><input type="text" name="tema" id="tema" style="width:300px"  value="@php echo $_REQUEST['tema']; php@">
                <img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle"></td>
        </tr>
        <tr>
            <td>Контактное лицо:&nbsp;&nbsp;&nbsp; </td>
            <td><input type="text" name="name" id="name" style="width:300px"  value="@php echo $_REQUEST['name']; php@">
                <img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle"></td>
        </tr>
        <tr>
            <td>E-mail: </td>
            <td><input type="text" name="mail" id="mail" style="width:300px"  value="@php echo $_REQUEST['mail']; php@"></td>
        </tr>
        <tr>
            <td>Телефон: </td>
            <td><input type="text" name="tel" id="tel" style="width:300px"  value="@php echo $_REQUEST['tel']; php@"></td>
        </tr>
        <tr>
            <td>Компания: </td>
            <td><input type="text" name="company" id="company" style="width:300px"  value="@php echo $_REQUEST['company']; php@"></td>
        </tr>
        <tr>
            <td>Сообщение:</td>
            <td><textarea style="height:150px; width:300px;" name="content"  id="content">@php echo $_REQUEST['content']; php@</textarea>
                <img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle"> </td>
        </tr>
    </table>
    <table width="100%">

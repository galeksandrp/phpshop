<div class="plashka_center">Подбор по параметрам</div>

<a name="up"></a>
<div class="page_nava">
  <div ><a href="/">Главная</a> /  Подбор по параметрам</div>
</div>
...
<div style="float:right;"><a href="#down" ><img src="images/shop/1.gif" alt="" width="15" height="16" border="0" align="absmiddle">Вниз</a></div>
...
<div style="float:right;"><a href="#up" ><img src="images/shop/2.gif" alt="" width="15" height="16" border="0" align="absmiddle">Наверх</a></div>
	<div>@productPageNav@</div>

<div class="plashka_center">Пожаловаться на цену</div>
			<div class="page_nava">
<div>
...
<div class="plashka_center">Личные данные</div>
<p></p>
...
<tr valign="top">
	...
	<td>
	<input type="text" name="mail" style="width:250px; height:18px; font-family:tahoma; font-size:11px ; color:#4F4F4F " maxlength="30" value="@UserMail@" @formaLock@> *
	</td>
</tr>
<tr>
...
<tr>
  <td></td>
  <td>
  <div  id=allspecwhite><img src="images/shop/comment.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle">Данные, отмеченные <b>звёздочками</b> обязательны для заполнения.<br>
</div>

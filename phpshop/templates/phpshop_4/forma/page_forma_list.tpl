...
<tr>
	...
	<td><input type="text" name="tema" id="tema" style="width:300px" value=""> *</td>
</tr>
<tr>
	<td>Контактное лицо:&nbsp;&nbsp;&nbsp;
	</td>
	<td><input type="text" name="name" id="name" style="width:300px" value=""> *</td>
</tr>
<tr>
	<td>E-mail:
	</td>
...
<tr>
	<td>Сообщение:</td>
	<td><textarea style="width:300px; height:200px;" name="content"></textarea> *
...
<tr>
	...
	<td>Введите код, указанный на картинке<br><input type="text" name="key" style="width:220px;"> *</td>
</tr>
<tr>
   <td colspan="2">	<br>
<div id=allspec><img src="images/shop/comment.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle">Данные, отмеченные <b>звёздочками</b> обязательны для заполнения.<br>

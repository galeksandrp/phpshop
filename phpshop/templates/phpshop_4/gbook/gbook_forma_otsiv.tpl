<div class="plashka_center">Форма отзыва</div>
...
<tr>
	...
	<DIV class="gbook_otvet"><IMG height=16 alt="" hspace=5 src="images/shop/comment.gif" width=16 align=absMiddle border=0>Данные, отмеченные <B>звёздочками</B> обязательны для заполнения. Отзыв будет размещен только после проверки модератором.<br>

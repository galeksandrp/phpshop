...
<form method="post" name="user_forma">
	<div><input type="text" class="user" name="login" placeholder="Логин" value=""></div>
	<div class="user_pad_2"> <input class="user_2" type="password" placeholder="Пароль" name="password" ><span class="user_pad_3"></span>

<table cellpadding="5" cellspacing="0" border="1" width="100%" style="margin-bottom: 10px">
  <tr>
    <td>
      <a href="/shop/UID_@productUid@.html"  title="@productName@"><img src="@productImg@" lowsrc="images/shop/no_photo.gif" onload="EditFoto(this,@productImgWidth@)" onerror="NoFoto(this,'@pathTemplate@')"  alt="@productName@" title="@productName@" border="0"></a>
    </td>
  </tr>
  <tr>
	<td>

...
<HTML>
    <HEAD>
        ...
        <link id="template_theme" href="@php echo $GLOBALS['SysValue']['dir']['templates'].chr(47).$_SESSION['skin']; php@/@sky_theme@.css" rel="stylesheet">
    ...
    <BODY onLoad="default_load('false', 'false'); NavActive('index'); LoadPath('@ShopDir@');" id="bod" class="bod">

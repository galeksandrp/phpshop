...
<NOINDEX>
    <form method="post" action="/shop/CID_@productId@.html" name="sort">
        <table width="704" class="filt6" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="3" height="29"><div class="divSortPageList">Сортировать по: наименованию ( <span class="spanSortPageList"><a href="?@productVendor@&f=1&amp;s=1">возр</a> / <a href="?@productVendor@&f=2&amp;s=1">убыв</a></span> ), цене ( <span class="spanSortPageList"><a href="?@productVendor@&f=1&amp;s=2">возр</a> / <a href="?@productVendor@&f=2&amp;s=2">убыв</a></span> )</div></td>
            </tr>
            <tr>

<div id="bg_catalog_1">Форма отзыва</div>
<div id="bglist"></div>
<table cellpadding="5" cellspacing="1" border="0" class="text_1">
<form action="./" method="post" name="forma_gbook">
<tr>
...
<tr>
	...
	<DIV id=allspec><IMG height=16 alt="" hspace=5 src="images/shop/comment.gif" width=16 align=absMiddle border=0>Данные, отмеченные <B>флажками</B> обязательны для заполнения.</DIV>
<p><br></p>
<table>
<tr>
...
<td>
	...
	<a href="javascript:forma_gbook.reset();"><u class=style1>Очистить форму</u></a></td>
<td width="20"></td>
	<td><img src="images/shop/brick_go.gif" alt="" width="16" height="16" border="0">
	<a href="javascript:Fchek();"><u class=style1>Добавить отзыв</u></a></td>

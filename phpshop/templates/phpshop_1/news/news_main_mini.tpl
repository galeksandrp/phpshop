<table style=" background:url(images/news_bg.gif) bottom left repeat-x;margin:8px 0px;" cellpadding="0" cellspacing="0" >
<tr>
...
<tr>
    <td class="text_1" style="padding:10px 0px 15px " colspan="2">
	@newsKratko@
	</td>
</tr>
</table>
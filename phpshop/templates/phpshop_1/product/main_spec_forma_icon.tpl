<table align="center"  style=" background:url(images/news_bg3.gif) bottom center no-repeat;margin:10px 0px;"  width="200" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="top" width="103" align="center"><A class="highslide" onclick="return hs.expand(this)" href="@productImgBigFoto@" target="_blank" getParams="null" title="@productName@"><img src="@productImg@" alt="@productName@" title="@productName@" lowsrc="images/shop/no_photo.gif"  onerror="NoFoto(this,'@pathTemplate@')"  border="0" ></A><div class=highslide-caption>@productName@</div></td>

...
<tr>
	<td width="150"><A href="../shop/UID_@productUid@.html" class="style11" style="font-weight: bold;font-size:12px;" title="АРТ:@productArt@"><img src="@productImg@" alt="@productName@" border="0"></A></td>
	<td valign="middle">

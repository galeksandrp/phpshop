...
<tr>
	<td width="150"><A class="highslide" onclick="return hs.expand(this)" href="@productImgBigFoto@" target="_blank" getParams="null" title="АРТ:@productArt@"><img src="@productImg@" alt="@productName@" border="0"></A><div class=highslide-caption>@productName@</div></td>
	<td valign="middle">

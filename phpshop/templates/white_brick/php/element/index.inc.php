...
// меняем параметры для звёзд в отзывах
$_SESSION['Memory']["rateForComment"]["oneStarWidth"] = 0; // ширина одной звёздочки
$_SESSION['Memory']["rateForComment"]["oneSpaceWidth"] = 0; // пробел между звёздочками

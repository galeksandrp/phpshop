<div class="pbox" style="position:relative">
 ...
 <a href="/shop/UID_@productUid@@nameLat@.html" title="@productName@">  <div class="description hidden-phone hidden-tablet">@productDes@</div></a>
    ...
    <div class="price"> @ComStart@
        ...
        @ComEnd@ </div>
    <div class="cart"> @ComStartCart@<a class="button" href="javascript:AddToCart(@productUid@)" title="@productSale@">@productSale@</a>@ComEndCart@
        @ComStartNotice@<a class="button" href="/users/notice.html?productId=@productUid@" title="@productNotice@">@productNotice@</a>@ComEndNotice@ </div>

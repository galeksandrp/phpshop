        ...
        <form id="chatform">
            ...
            <div class="controls">
                <div class="input-append">
                    <input class="span2"  style="padding:4px"  name="chat_mod_user_name" id="chat_mod_user_name" required="" value="@php echo $_SESSION[mod_chat_user_name]; php@" id="chat_mod_user_name" size="20" type="text" placeholder="Имя">
...
<a href="#chatModalPre" data-toggle="modal" data-target="#chatModalPre" class="btn btn-default btn-sm"><i class="icon-user"></i> Начать чат</a>

<form method="post" name="forma_message">
    <table width="100%" cellpadding="5" class="forma_message">
        ...
        <tr>
            <td>Телефон: </td>
            <td><input type="text" name="tel" id="tel_forma" style="width:290px"  value="@php echo $_REQUEST['tel']; php@"></td>
        </tr>
        <tr>
            <td>Компания: </td>
        ...
        <tr>
            <td>Сообщение:</td>
            <td><textarea style="height:150px; width:290px;" name="content"  id="content">@php echo $_REQUEST['content']; php@</textarea>
                <img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle"> </td>
        </tr>
    </table>
    <table width="100%">

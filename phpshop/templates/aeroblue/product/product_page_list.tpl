...
<div style="float:right;"><a href="#down" style="color:AC8694"><img src="images/shop/2.gif" hspace="3" border="0" align="absmiddle">Вниз</a></div>
...
<div style="float:right;"><a href="#up" style="color:AC8694"><img src="images/shop/1.gif" alt="" hspace="3" border="0" align="absmiddle">Наверх</a></div>
	<div>@productPageNav@</div>

...
<HR>
		...
		<TR>
			...
			<TD valign="top"><a href="http://@serverShop@/shop/UID_@productId@.html" style="text-decoration:none;color:black" title="@productName@"><H4>@productName@ / @productPrice@ @productValutaName@</H4></a><br>
<div class="nonprint">

...
<BODY onLoad="default_load('false','false');NavActive('index');">
...
@oprosDisp@</div>
 ...
 <div id="bg_catalog_1"><table border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td valign="top" width="226" style="padding-top:14px">@usersDisp@<div id="bg_catalog_1" style="margin-top:15px;">Новинки каталога</div>@specMainIcon@
    @rightMenu@</td>
  </tr>
</table>
</td>

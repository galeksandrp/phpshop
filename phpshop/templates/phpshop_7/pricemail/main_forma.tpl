...
<a href="/">Главная</a> / Пожаловаться на цену
</div></div>

<table cellpadding="0" cellspacing="0" border="0" class="catalogOptionTable">
	<tbody>
		<tr>
		  <td align="left" valign="bottom"><div class="catalogOption_zag"><div class="plashka_zag">Пожаловаться на цену</div></div></td>
		</tr>
	</tbody>
</table>
...
<tr>
	<td><table cellpadding="0" cellspacing="0" border="0" class="tovarDivImg2" align="left"><tr><td align="center" valign="middle"><img src="@productImg@" alt="" border="0"></td></tr></table></td>
...
<tr>
	...
	<td>
	<input type="text" name="name_person" style="width:250px; height:18px; font-family:tahoma; font-size:11px ; color:#4F4F4F " maxlength="30" value="@UserName@" @formaLock@><img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle">
	</td>
</tr>
<tr>
	<td align="right" >
	...
	<td>
	<input type="text" name="link_to_page" style="width:250px; height:18px; font-family:tahoma; font-size:11px ; color:#4F4F4F " maxlength="100" ><img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0" hspace="5" align="absmiddle">
	</td>
</tr>
<tr>
	<td align="right" >

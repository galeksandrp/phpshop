<table cellpadding="0" cellspacing="0" border="0" width="220">
    <tbody>
        ...
        <tr>
            <td height="130" valign="top"><div class="tovarDivName1"><a href="/shop/UID_@productUid@.html" title="@productName@">@productName@</a></div><sapn class="tovarDivArt">@productArt@</span>

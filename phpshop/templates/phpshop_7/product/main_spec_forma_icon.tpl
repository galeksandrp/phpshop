<div class="newtipDivleST">
    <table cellpadding="0" cellspacing="0" border="0" class="newtipTableST" width="100%">
        <tbody>
            ...
            <tr>
                <td height="110" valign="top"><div class="tovarDivName1"><a href="/shop/UID_@productUid@.html" title="@productName@">@productName@</a></div><sapn class="tovarDivArt">@productArt@</span>
            ...
            <div class="tovarDivAdd1"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody>
                        <tr>

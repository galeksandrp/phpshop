<tr class="product-tr">
    <td  colspan="2">
        <div class="flex align-center prod-img-name"> <span class="product-cart-img"><a href="/shop/UID_@cart_id@.html" title="@cart_name@"><img src="@cart_pic_small@" border="0" hspace="5" vspace="5" align="absmiddle" style="max-width: 40px; max-height: 40px;"></a></span>
    ...
    <td align="right"><span class="nowrap">@cart_price_all@ <span class="rubznak">@currency@</span> <br><s class="text-muted">@cart_price_all_old@</s></span></td>
    <td >
        <table  align="center">
            <tr>
                ...
                <td style="padding-left:5px">
                    <form name="forma_cart_del" method="post" id="forma_cart_del">
                        <button type="submit" class="cart-delete-wrap label"  ><span class="cart-delete">+</span></button>
    ...
    <td>
        <a class="addToWishList" href="#" data-uid="@cart_xid@">

...
$(document).ready(function() {
   ...
   // Ïîêàç áëîêà ñåé÷àñ êòî-òî êóïèë
   $(".modal-nowBuy").fadeIn(2000).delay(7000).fadeOut(1000);
    
    // Çàêðûòü áëîê ñåé÷àñ êòî-òî êóïèë
    ...
    clock.setTime(msTillMidnight); //Ð£ÑÑ‚Ð°Ð½Ð°Ð²Ð»Ð¸Ð²Ð°ÐµÐ¼ Ð½ÑƒÐ¶Ð½Ð¾Ðµ Ð²Ñ€ÐµÐ¼Ñ Ð² ÑÐµÐºÑƒÐ½Ð´Ð°Ñ…
    clock.setCountdown(true); //Ð£ÑÑ‚Ð°Ð½Ð°Ð²Ð»Ð¸Ð²Ð°ÐµÐ¼ Ð¾Ñ‚ÑÑ‡ÐµÑ‚ Ð²Ñ€ÐµÐ¼ÐµÐ½Ð¸ Ð½Ð°Ð·Ð°Ð´
    clock.start(); //Ð—Ð°Ð¿ÑƒÑÐºÐ°ÐµÐ¼ Ð¾Ñ‚ÑÑ‡ÐµÑ‚

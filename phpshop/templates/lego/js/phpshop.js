...
function topMenuFix() {
    ...
    if (body_width > 768) {
		...
		console.log('tnw'+ top_nav_weight)
        var full_weight = 0;
        ...
        console.log('tfw' + top_full_weight);
        ...
        console.log('tnwf' + top_nav_weight_fix)
...
$(document).ready(function() {
    ...
    /*   $(".breadcrumb, .template-slider").waypoint(function() {
     if (FIXED_NAVBAR)
     $(".top-menu").toggleClass("navbar-fixed-top");
  ...
  /*  $(".product-block-wrapper-fix").on("click", ".addToCartList", function() {
    ...
    $(".product-block-list").on("click", ".addToCartList", function() {
...
// добавление в корзину
   $('body').on('click', 'button.addToCartList', function() {
        ...
        $("#order").addClass("active");
		if ($(this).hasClass('listBtn')) { $(this).addClass("btn-success");
		$(this).children('.btn-text').text('В корзине')}
    });
   $('body').on('click', 'button.addToCartFull', function() {
...
$(window).resize(function() {
  ...
  if (body_width > 769) {    if ($(".bxslider").length) {
        $(".bxslider-pre").addClass("hide");
        $(".bxslider").removeClass("hide");
                        ...
                        if (json["id"] > 0) {
                            if (
                                ...
                                addToCartList(
                                        json["id"],
                                        $('input[name="quant[2]"]').val(),
                                        $('input[name="parentColor"]:checked').attr("data-parent")
                                        );
                            else

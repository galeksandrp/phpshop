<div class="modal-nowBuy">
    <img src="@product_nowBuy_img@" alt="@product_nowBuy_name@" title="@product_nowBuy_name@">
    <div class="nowBuy-info">
        ...
        <p class="nowBuy-sklad">Осталось в наличии:<br>@product_nowBuy_items@ шт.</p>
    </div>
</div>
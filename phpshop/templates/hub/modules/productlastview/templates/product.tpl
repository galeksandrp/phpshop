...
<div class="media">
    ...
    <div class="media-body">
        ...
        </a> <span class="pull-right text-muted">@productlastview_product_price@ <span class="rubznak">@productlastview_product_currency@</span></span><span class="price-old">@productlastview_product_price_old@</span>
    </div>
</div>

                        ...
                        <tr>
                            <td valign="top" id="header_1" >
                                <table width="999" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="225" align="center"><a href="/" title="@name@"><img src="@logo@" alt="@name@" border="0" alt="@name@"></a></td>
                        ...
                        <tr>
                            <td valign="top"><table width="999" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td  width="559" id="header_2"><a href="/" class="navigation" >Главная</a>
                                                    @topMenu@
            ...
            <tr>
                <td valign="top" id="footer"><table width="999" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="774" valign="top" id="foot_nav">

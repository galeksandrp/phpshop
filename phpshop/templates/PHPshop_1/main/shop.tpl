...
<BODY onLoad="pressbutt_load('@thisCat@','@pathTemplate@','false','false');NavActive('@NavActive@');">
...
<div id="bg_catalog_2">Каталог</div>
    ...
    <div id="cat_in">   <ul class="catalog">
			   ...
			   <li class="catalog2"><a href="/users/message.html" title="Форма связи">Форма связи</a>
			   </ul>

    ...
    <NOINDEX>
        <form method="post" action="./CID_@productId@.html" name="sort">
            <table cellpadding="0" cellspacing="0" >
                <tr>
                    <td class="black">
                        Сортировка по: <a href="?@productVendor@&f=@productSortNext@&s=@productSort@" title="Изменить направление"><img src="images/shop/@productSortImg@.gif" alt="Изменить направление" hspace="2" border="0" align="absmiddle"></a><a href="?@productVendor@&f=@productSortTo@&s=1" class="@productSortA@">алфавиту</a> - <a href="?@productVendor@&f=@productSortTo@&s=2"  class="@productSortB@">цене</a> - <a href="?@productVendor@&f=@productSortTo@&s=3"  class="@productSortC@">популярности</a>
                    </td>

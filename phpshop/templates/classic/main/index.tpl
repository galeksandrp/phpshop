...
<HTML>
    <HEAD>
        ...
        <link id="template_theme" href="@php echo $GLOBALS['SysValue']['dir']['templates'].chr(47).$_SESSION['skin']; php@/@classic_theme@.css" rel="stylesheet">
                                ...
                                <div style="padding-top:5px;padding-left:10px">
                                    <table >
                                        <FORM method="post" name="forma_search" action="/search/" onsubmit="return SearchChek()">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <a href="/search/" class="white">+ расширенный поиск</a>
                                                </td>
                                            </tr>
                                        </FORM>
                                    </table>
                        ...
                        <tr>
                            ...
                            <td width="275"  valign="top" class="left_block"><img src="images/spacer.gif" alt="" width="275" height="1" border="0">@skinSelect@
                                ...
                                <a href="/news/"><DIV class=catalog_forma style="CURSOR: pointer" onclick="javascript:location.replace('/news/')"><TABLE cellSpacing=0 cellPadding=0 width=275 border=0>
                                            <TBODY>
                                                <TR>
                                                    <TD style="PADDING-LEFT: 62px; PADDING-TOP: 15px">Новости</TD></TR></TBODY></TABLE></DIV></a>
                                <a href="/gbook/"><DIV class=catalog_forma style="CURSOR: pointer" onclick="javascript:location.replace('/gbook/')"><TABLE cellSpacing=0 cellPadding=0 width=275 border=0>
                                            <TBODY>
                                                <TR>
                                                    <TD style="PADDING-LEFT: 62px; PADDING-TOP: 15px">Отзывы</TD></TR></TBODY></TABLE></DIV></a>
                                <a href="/price/"><DIV class=catalog_forma style="CURSOR: pointer" ><TABLE cellSpacing=0 cellPadding=0 width=275 border=0>
                                            <TBODY>
                                                <TR>
                                                    <TD style="PADDING-LEFT: 62px; PADDING-TOP: 15px">Прайс-лист</TD></TR></TBODY></TABLE></DIV></a>
                                @pageCatal@
                                @leftMenu@
                                @oprosDisp@
                                @cloud@
...
<br><div align="center">@button@</div>

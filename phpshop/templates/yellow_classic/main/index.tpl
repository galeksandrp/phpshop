                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>  <div id="order" style="display:@orderEnabled@; padding-left:20px"><A href="/order/" style=" font-weight: bold;">Оформить заказ</A></div>
                                            ...
                                            <div id="compare" style="padding-left:20px;padding-top:5px;display:@compareEnabled@" ><a href="/compare/" title="Сравнение товаров"  style="font-weight: bold;">Сравнить товары</div>

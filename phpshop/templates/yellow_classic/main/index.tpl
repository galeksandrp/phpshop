...
<TABLE WIDTH="1004" BORDER="0" CELLPADDING="0" CELLSPACING="0">
	<TR>
		<TD COLSPAN="2" id="header_1"></TD>
		<TD COLSPAN="2" id="header_2" valign="top">
		<div  style="padding-top:15px;padding-right:20px" class="gray">
		<a href="/" class="gray">домой</a>&nbsp;&nbsp;|&nbsp;
			<a href="#" onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://@serverName@')" class="gray">стартовая</a>&nbsp;&nbsp;|&nbsp;
			<a href="#" onclick="window.external.AddFavorite('http://@serverName@/','@serverName@')" class="gray">в избранное</a>
		</div>
		</TD>
	</TR>
	<TR>
...
<tr>
	<td id="index"><a href="/" style="font-weight: bold;text-decoration: none;">Главная</a></td>
...
<tr>
    <td>@valutaDisp@</td>
    <td>  <div id="order" style="display:@orderEnabled@; padding-left:20px"><A href="/order/" style="font-weight: bold;">Оформить заказ</A></div>

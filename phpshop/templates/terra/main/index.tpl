		...
		<div class="row">
			<div class="col-xs-12">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#newprod">Новинки</a></li>
					<li><a data-toggle="tab" href="#specprod">Спецпредложения</a></li>
				</ul>
				...
				<!-- Popular Products Starts -->
                                <h2 class="product-head">Популярные товары</h2>

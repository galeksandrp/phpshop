<div class="breadcrumb">
    <div> <a href="/">Главная</a> <span>»</span> Пожаловаться на цену </div>
</div>
...
<div align="center" style="padding:10px">
    <table>
        <tr>
            <td><table  class="tovarDivImg2" align="left">
                    <tr>
                        <td align="center" valign="middle"><img src="@productImg@" alt="" ></td>
                    </tr>
                </table></td>
...
<form method="post" name="forma_pricemail">
    <table  cellpadding="5" cellspacing="0" width=98% >
        ...
        <tr>
            <td></td>
            <td><div  id=allspecwhite><img src="images/shop/comment.gif" alt="" width="16" height="16"  hspace="5" align="absmiddle">Данные, отмеченные <b>флажками</b> обязательны для заполнения.<br>
                </div></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" align="center"><p><br>
                ...
                <table align="center">
                    <tr>
                        <td><img src="images/shop/brick_error.gif"  align="absmiddle"> <a href="javascript:forma_pricemail.reset();" class=link>Очистить форму</a></td>
                        <td width="20"></td>
                        <td><img src="images/shop/brick_go.gif"   align="absmiddle"> <a href="javascript:CheckPricemail();" class=link>Отправить сообщение</a></td>
                    </tr>
                </table>

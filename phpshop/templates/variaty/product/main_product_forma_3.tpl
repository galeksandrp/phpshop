<div class="cart_panel span3">
  ...
  <a href="#modal" data-role="/shop/UID_@productUid@.html" class="btn btn-small fastView" data-toggle="modal" data-hover="tooltip"><i class="icon-eye-open"></i> Быстрый просмотр</a>

...
<form method="post" name="forma_order" id="forma_order" action="/done/">
    <div id="checkout">
        ...
        <hr>
            ...
            <div class="checkout-content" style="display: block;">
                <div class="left">
                     <a href="javascript:forma_order.reset();" class="btn btn-default"><img src="images/shop/brick_error.gif" align="absmiddle">Очистить форму</a>
                ...
                <div id="login" class="right">
                     <a href="javascript:OrderChekJq();" class="btn btn-primary"><img src="images/shop/brick_go.gif" align="absmiddle">Оформить заказ</a>
                </div>
            </div>
            <BR>
        </div>

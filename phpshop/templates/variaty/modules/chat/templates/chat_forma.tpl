        ...
        <div class="control-group">
            <div class="controls">
                <div class="input-append">
                    <input class="span2"   name="chat_mod_user_name" id="chat_mod_user_name" required="" value="@php echo $_SESSION[mod_chat_user_name]; php@" id="chat_mod_user_name" size="20" type="text" placeholder="Имя">
                    <button type="submit" class="btn btn-default btn-sm" id="chatstart">@php if(empty($_SESSION['mod_chat_user_session'])) echo "Начать"; else echo "Далее"; php@</button>

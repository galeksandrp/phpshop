...
setEqualHeight('.product-col:not(.product-day, .page)');	}, 400);
...
$(document).ready(function() {
	...
	setEqualHeight('.product-img-centr');
	setEqualHeight('.description-content');
setEqualHeight('.product-col:not(.product-day, .page)');	}, 200);
...
// выбор цвета 
    ...
    if (usecookie == undefined && COOKIE_AGREEMENT) {
	 ...
	 $('div:contains("Все права защищены")').parents('.visible-lg').css('position', 'absolute');
 $('div:contains("Все права защищены")').parents('.visible-lg').css('bottom', '0');

                ...
                <div class="media-body">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <a href="//@serverShop@/shop/UID_@productId@.html" title="@productName@" class="pull-right"><span class="glyphicon glyphicon-share-alt"></span> http://@serverShop@/shop/UID_@productId@.html</a>
                        </div>
                    </div>

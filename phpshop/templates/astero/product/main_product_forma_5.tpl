...
<span class="product-sklad-list-block">@productSklad@</span>
            ...
            <div class="cart-button button-group">
                ...
                <button class="btn btn-wishlist addToWishList" role="button" data-uid="@productUid@" data-title="{ќтложить}" data-placement="top" data-toggle="tooltip"><i class="icon-heart"></i></button>
                <button class="btn btn-wishlist addToCompareList" role="button" data-uid="@productUid@" data-title="{—равнить}" data-placement="top" data-toggle="tooltip"><i class="icon-sliders"></i></button>

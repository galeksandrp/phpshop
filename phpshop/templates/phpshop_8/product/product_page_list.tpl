...
<div class="page_nava">
  <div ><a href="/">Главная</a> / <A href="/shop/CID_@catalogId@.html" title="@catalogCat@">@catalogCat@</A> / <span>@catalogCategory@</span></div>
</div>
<div> @catalogContent@ </div>
<form method="post" action="/shop/CID_@productId@.html" name="sort">
<div id="allspec_page_list">
	<div class="priceLink"><a href="/price/CAT_SORT_@pcatalogId@.html" title="Прайс-лист каталога @catalogCategory@" class="link">Прайс-лист каталога</a></div>
    <div style="width: 100%">
...
<table cellpadding="0" cellspacing="0" border="0" class="catalogOptionTable1">
	<tbody>
		<tr>
		  ...
		  <td align="right" valign="middle"><div class="divSortPageList">Цена: &nbsp; <a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=2&amp;s=2"><img src="images/furniture_24.gif" align="absmiddle" border="0"></a> <span class="spanSortPageList"><a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=2&amp;s=2">возр</a> <a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=1&amp;s=2"><img src="images/furniture_25.gif" align="absmiddle" border="0"></a> <a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=1&amp;s=2">убыв</a></span></div></td>
		</tr>
	</tbody>
</table>
</form>

...
<table cellpadding="0" cellspacing="0" border="0" class="catalogOptionTable1">
	<tbody>
		<tr>
		  ...
		  <td align="right" valign="middle"><div class="divSortPageList">Цена: &nbsp; <a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=2&amp;s=2"><img src="images/furniture_24.gif" align="absmiddle" border="0"></a> <span class="spanSortPageList"><a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=2&amp;s=2">убыв</a> <a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=1&amp;s=2"><img src="images/furniture_25.gif" align="absmiddle" border="0"></a> <a href="./CID_@productId@_@productPageThis@.html?v=@productVendor@&f=1&amp;s=2">возр</a></span></div></td>
		</tr>
	</tbody>
</table>
</form>

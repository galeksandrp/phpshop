  ...
  <tbody>
    <tr>
      ...
      <td valign="top" class="cartTableTd3"><h1 class="cartName">@productName@</h1>
        ...
        @ComEndCart@ <span class="productSklad">@productSklad@</span>
        <div class="productBay-1">
          ...
          <div class="productBay-3"> <span class="sp1"><a href="javascript: void(addBookmark() || alert('Ваш браузер не поддерживает автоматическое добавление закладок.'))" title="Добавить в избранное">Добавить в избранное</a></span> <span class="sp2"><a href="/order/" title="Перейти в корзину">Перейти в корзину</a></span> </div>
        </div>
        ...
        <!-- Блок пожаловаться -->
        @ComStartCart@ <a href="/pricemail/UID_@productId@.html" title="Пожаловаться на цену">Пожаловаться на цену</a> @ComEndCart@
        <!-- Блок пожаловаться -->

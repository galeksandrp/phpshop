          ...
          <table cellpadding="0" cellspacing="0" border="0" id="TContent">
            <tbody>
              <tr>
                ...
                <td align="left" valign="top" class="rightCat"><div class="space4"> @php
                    $url = $_SERVER['REQUEST_URI'];
                    $urlsub = substr($url,0,6);
                    if($urlsub == '/shop/'){echo "<h1 class='HTitle2'>Каталог</h1>";
include_once($GLOBALS['SysValue']['dir']['templates'].chr(47).$_SESSION['skin'].chr(47)."php/template_php.php");
          ...
          <div id="DBotoom-t"><div id="DBotoom-b">
            <p class="PBotoom">Copyright &copy; 2010 Интернет-магазин «@pageReg@» Тел: @telNum@<span></span>Все права защищены.</p>
          </div>

                            ...
                            <div class="headerfone_2">
                                <div class="headerfone_3">
                                    <div class="headertable">
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" height="125">
                                            <tbody>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="50%" align="left" valign="top" class="newTipTable">
                                                        @showcase@
                                                    </td><td><div class="headerdiv_right"></div></td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="99%" align="left" valign="top">
                                                    ...
                                                    <div class="plashka_center_news">@mainContentTitle@</div>
                                                    <div class="news_content">@mainContent@</div>

                                                    <div class="plashka_center_newtip">Спецпредложения магазина</div>

...
<HTML>
    <HEAD>
        ...
        <link id="template_theme" href="@php echo $GLOBALS['SysValue']['dir']['templates'].chr(47).$_SESSION['skin']; php@/@aero_theme@.css" rel="stylesheet">
                ...
                <td>
                    ...
                    <div class="header_bg_2_up radius_up">
                        ...
                        <div class="header_bg_2_up_sum">
                            <div>на сумму: <span id="sum" style="DISPLAY: inline; FONT-WEIGHT: bold">@sum@</span> @productValutaName@
                            </div>
                        </div>
                        ...
                        <div class="header_bg_2_shop">
                            <div style="padding-top:60px">
                                <div class="header_phpshop_logo">
                                    <a title="@name@" href="/"><img src="@logo@" alt="@name@" border="0" alt="@name@"></a>
                                </div>
                                ...
                                <div class="header_user_area">
                                    <img src="images/spacer.gif" alt="" width="62" height="70" border="0"  align="absmiddle" class="iePNG">
                                </div>
                                        ...
                                        <table cellspacing="0" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding-left: 5px">
                                                    <input type="image" class="but_search" src="images/spacer.gif" width="63" height="21">
                                                </td>
                                            </tr>
                                            <tr>

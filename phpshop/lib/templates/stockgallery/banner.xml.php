...
if (empty($_GET['background']))
    $background = '/phpshop/lib/templates/stockgallery/empty.png';
else
    $background = '/phpshop/lib/templates/stockgallery/src.jpg';
...
if (is_array($data))
    ...
    $XML.= '<item price="" image="images/shop/no_photo.gif" url="/">' . PHPShopString::win_utf8("Добавьте товары в базу") . '</item>';

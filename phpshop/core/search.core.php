...
class PHPShopSearch extends PHPShopShopCore {
    ...
    function category_select() {
        ...
        $disp= PHPShopText::select('cat',$this->value,'400',$float="none",false,$onchange="proSearch(this.value)",$height=false,$size=1,'cat');
    ...
    function setPaginator($count) {
        ...
        if($num>1) {
            ...
            while ($i<=$num) {
                ...
                if($i!=$this->page) {
                    $navigat.=PHPShopText::a("./?words=".$this->search_order['words']."&pole=".
                            $this->search_order['pole']."&set=".$this->search_order['set']."&p=".$i."&cat=".$this->search_order['cat'],
                            $p_start.'-'.$p_end).' / ';
            ...
            $nav.=PHPShopText::a("./?words=".$this->search_order['words']."&pole=".
                    $this->search_order['pole']."&set=".$this->search_order['set']."&p=".$p_do."&cat=".$this->search_order['cat'],
                    PHPShopText::img('images/shop/3.gif',1,'absmiddle'),$this->lang('nav_back'));
            $nav.=$navigat;
            $nav.=PHPShopText::a("./?words=".$this->search_order['words']."&pole=".
                    $this->search_order['pole']."&set=".$this->search_order['set']."&p=".$p_to."&cat=".$this->search_order['cat'],
                    PHPShopText::img('images/shop/4.gif',1,'absmiddle'),$this->lang('nav_forw'));

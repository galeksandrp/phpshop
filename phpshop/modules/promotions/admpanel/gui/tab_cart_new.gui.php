...
function tab_cart_new($data, $option = false) {
    ...
    // Торг-12
    $blank.=$PHPShopGUI->setButton(__('Торг-12'), '../img/action_print.gif', 130, 30, $float = "left", $onclick = "DoPrint('/phpshop/modules/promotions/admpanel/forms/forma5.php?orderID=" . $data['id'] . "'); return false;");
    // Почта

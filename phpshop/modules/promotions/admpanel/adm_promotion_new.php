...
function actionInsert() {
    ...
    if(empty($_POST['enabled_new'])) $_POST['enabled_new']=1;
...
function actionStart() {
    ...
    $PHPShopGUI->dir=$_classPath."admpanel/";
    $PHPShopGUI->title="Создание новой промо-акции";
    ...
    $PHPShopGUI->setHeader("Создание новой промо-акции","",$PHPShopGUI->dir."img/i_display_settings_med[1].gif");
    ...
    $Tab1=$PHPShopGUI->setField('Название',$PHPShopGUI->setInputText('','name_new',$name,'300',false,'left').
        $PHPShopGUI->setText($PHPShopGUI->setRadio("enabled_new[]", 1, "Показывать", 'checked') . 
    ...
    $categories_mul_sel .= '<select multiple size="5" id="categories" style="width:100%;" name="categories[]">'.$categories_option.'</select>';

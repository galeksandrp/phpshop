...
<table width=99% cellpadding=2 cellspacing=0 align=center>
    ...
    ?>
    <tr>
        <td colspan=5 align=right style="border-top: 1px solid #000000;border-left: 1px solid #000000;border-right: 1px solid #000000;">Скидка: <?= @$order['Person']['discount_promo'].$tip_disc ?></td>
    </tr>
    <tr>

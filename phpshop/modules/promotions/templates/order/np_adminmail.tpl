...
<tbody>    
    <tr bgcolor="#fafafa" id="header" valign="top">
        <td id="logo" align="left" valign="bottom">
            ...
            <p><h2>Поступил заказ на сумму @totalsumma@ руб. от @user_name@ <br>(@mail@)</h2></p></div>
        </td>     
    </tr>
...
<hr><p>@cart@</p>
<hr>
<p>Итого -- @totalsumma@ @currency@<br>
Доставка -- @deliveryp@<br></p>
<hr>
<p>Итого к оплате с учетом скидки: @totalsumma@ @currency@</p>

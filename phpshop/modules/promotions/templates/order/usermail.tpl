...
<tbody>    
    <tr bgcolor="#808080" id="header" valign="top">
        <td id="logo" align="left" valign="bottom">
            <div align="center">
            <p><h2 style="color:#fff;">Промо-код: @promocode@</h2></p></div>
        </td>     
    </tr>
...
Скидка -- @discpromo@ @tipdisc@<br>
Доставка -- @deliveryp@<br></p>
<hr>
<p>Итого к оплате с учетом скидки: @totalsumma@ руб.</p><hr><p>

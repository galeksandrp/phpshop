...
<textarea class="form-control"><script src="http://@serverName@@ShopDir@phpshop/modules/partner/lib/js/phpshop-partner-lib.js" id="phpshop-lib-xml"></script>
<script>
...
<p>Подробности настройки PHPShop.CMS Micro описаны в <a href="http://wiki.phpshop.ru/index.php/Partner_Module">Wiki инструкции</a>.</p>
<p><a class="btn btn-default" title="Скачать Shop4Partner" href="http://mod.phpshop.ru/mod/partner/setup.exe"><span class="glyphicon glyphicon-download"></span> Скачать Shop4Partner</a></p>
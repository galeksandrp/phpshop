...
Установка полнофункциональной системы управления сайтом с модулем Catalog для трансляции товаров по партнерской программе.
...
<p>Подробности настройки PHPShop.CMS Micro описаны в <a href="http://wiki.phpshop.ru/index.php/Partner_Module">Wiki инструкции</a>.</p>
<p><input type="button" value="Скачать Shop4Partner" onclick="javascript:window.open('phpshop/modules/partner/files/setup.exe')"></p>
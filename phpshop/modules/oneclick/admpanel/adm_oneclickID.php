...
function actionStart() {
    ...
    $PHPShopGUI->dir = $_classPath . "admpanel/";
    $PHPShopGUI->title = "Редактирование быстрого заказа";
    ...
    $PHPShopGUI->setHeader('Редактирование заказа от "' . $name . '" номер ' . $tel, "Укажите данные для записи в базу.", $PHPShopGUI->dir . "img/i_display_settings_med[1].gif");

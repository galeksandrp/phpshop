...
function getInstruct() {
    return '
<p>Модуль Facebook Page установит специально адаптированные шаблоны-витрины для этой социальной сети.</p>
<p><strong>1.</strong>&nbsp;Залогиньтесь или создайте свой аккаунт на Facebook&nbsp;<a title="www.facebook.com" href="http://www.facebook.com/?from=phpshop">www.facebook.com</a>
<p><strong>2.</strong>&nbsp;Создайте страницу <a title="www.facebook.com/pages/create.php" href="http://www.facebook.com/pages/create.php?from=phpshop">www.facebook.com/pages/create.php</a>. Выберите вид "<span>Компания, организация или учереждение"</span>, далее выберите категорию, введи название компании и нажмите кнопку "Начало работы".</p>
...
<p><strong>Подробная нструкция со скриншотами:</strong> <a href="http://faq.phpshop.ru/page/facebook-templates.html" target="_blank">http://faq.phpshop.ru/page/facebook-templates.html </a></p>';
}
?>

...
function actionStart() {
    global $PHPShopInterface, $_classPath;
        ...
        $PHPShopInterface->link = "../modules/yandexkassa/admpanel/adm_yandexkassaID.php";
    ...
    $Calendar = $PHPShopIcon->setForm(
            ...
            $PHPShopIcon->setInput("button", "date_but", "Показать", "right", 70, "DoReload('modules','yandexkassa','yandexkassa',calendar.pole1.value,calendar.pole2.value)")

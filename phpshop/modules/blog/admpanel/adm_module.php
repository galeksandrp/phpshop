...
function actionStart() {
    ...
    $PHPShopGUI->setHeader("Настройка модуля 'Blog'","Настройки",$PHPShopGUI->dir."img/i_display_settings_med[1].gif");
    ...
    $Tab1=$PHPShopGUI->setField("Расположение блока записей:",
    ...
    $Info='
     Для произвольного размещения формы вывода последних записей блога отключите опцию вывода блока на сайте и используйте переменную @lastblogForma@

<tr>
    <td>
        <a href="@shopDir@/shop/UID_@visualcart_product_id@@visualcart_product_seo@.html" title="@visualcart_product_name@">
            <img src="@visualcart_product_pic_small@" width="@visualcart_pic_width@"  border="0" alt="@visualcart_product_name@">
        </a>
    </td>
    <td>
        <a href="@shopDir@/shop/UID_@visualcart_product_id@@visualcart_product_seo@.html" title="@visualcart_product_name@">
            @visualcart_product_name@ <!--[@visualcart_product_num@ шт.]-->
        </a> (<b>@visualcart_product_price@ @visualcart_product_currency@</b>)
    </td>
    <td>
        <a title="Удалить" href="javascript:visualCart(@visualcart_product_xid@)">

    ...
    $('.cart-add').on('click', function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#selectModal .modal-title').html('Добавление товаров');
                ...
                $('#selectModal .modal-footer .cart-add-send').after('<input class=\'btn btn-sm btn-primary\' data-id=' + id + ' type=\'button\' id=\'cart-add-send\' value=\'Выбрать\'>');

...
class saferoutewidget {
    ...
    public function option() {
        $PHPShopOrm = new PHPShopOrm($GLOBALS['SysValue']['base']['saferoutewidget']['saferoutewidget_system']);
...
class SaferouteHelper
{

    const PROD_URL = 'https://api.saferoute.ru/api/';

...
function actionStart() {
    ...
    $PHPShopGUI->dir = $_classPath . "admpanel/";
    $PHPShopGUI->title = "Редактирование стикера";
    ...
    $PHPShopGUI->setHeader("Редактирование стикера", "Укажите данные для записи в базу.", $PHPShopGUI->dir . "img/i_display_settings_med[1].gif");

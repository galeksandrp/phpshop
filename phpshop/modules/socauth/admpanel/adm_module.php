...
<li>в "Callback URL:" необходимо указать ссылку возврата на Ваш сайт: <code>http://вашДомен.ру/socauth/twitter/</code>
<li>в поле "WebSite: *" нужно указать адрес Вашего сайта: <code>http://вашДомен.ру</code>
...
сайт лежит на test.phpshop-partners.ru, нужно указать phpshop-partners.ru
<li>все поля ниже раздела основных данных оставить без изменения, кроме поля "Site URL"<br><br>
<li>в поле "Site URL" необходимо указать полностью адрес Вашего домена, например: http://test.phpshop-partners.ru
...
<li> в поле "Адрес сайта" необходимо указать полностью адрес Вашего домена, например: http://test.phpshop-partners.ru
<li>в поле "Базовый домен" необходимо указать Ваш домен (если сайт лежит на субдомене, нужно указывать только основной), например: сайт лежит на test.phpshop-partners.ru, нужно указать phpshop-partners.ru

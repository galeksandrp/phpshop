...
<body onload="window.focus()" bgcolor="#FFFFFF" text="#000000" marginwidth=5 leftmargin=5 style="padding: 2px;">
    ...
    <h2 class="blank_name">Заполнение бланка Ярлыка Ф.7</h2>
...
<form class="twelve columns" method="post" action="" id="blanks">
  <fieldset> 
    <fieldset id="recipient" class="validationEngineContainer">
      ...
      <div class="row">
        ...
        <div class="six columns left">
          <input placeholder="Имя Отчество" id="whom_name" type="text" value="" rel="" name="F7[whom_name]" class="twelve" maxlength="38">
        </div>
    ...
    <fieldset>
      <legend>Вид бланка ярлыка</legend>
      <div class="twelve columns">
        <label for="type_a"><input name="F7[type_blank]" type="radio" id="type_a" checked="" value="a"> Отправление 1 класса</label>
        <label for="type_b"><input name="F7[type_blank]" type="radio" id="type_b" value="b"> Бандероль</label>
        <label for="type_p"><input name="F7[type_blank]" type="radio" id="type_p" value="p"> Посылка</label>
      </div>
    </fieldset>

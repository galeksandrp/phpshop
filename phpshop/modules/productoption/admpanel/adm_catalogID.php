    ...
    if (is_array($vendor)) {
        ...
        if (!empty($vendor['option_6_name']))
            if($vendor['option_6_format'] == 'editor')
                $Tab10 .= $PHPShopGUI->setCollapse($vendor['option_6_name'], setModOptionGUI("option6_new", $vendor['option_6_format'], $data['option6']), 'in', false);
            else
        ...
        if (!empty($vendor['option_7_name']))
            if($vendor['option_7_format'] == 'editor')
                $Tab10 .= $PHPShopGUI->setCollapse($vendor['option_7_name'], setModOptionGUI("option7_new", $vendor['option_7_format'], $data['option7']), 'in', false);
            else
        ...
        if (!empty($vendor['option_8_name']))
            if($vendor['option_8_format'] == 'editor')
                $Tab10 .= $PHPShopGUI->setCollapse($vendor['option_8_name'], setModOptionGUI("option8_new", $vendor['option_8_format'], $data['option8']), 'in', false);
            else
        ...
        if (!empty($vendor['option_9_name']))
            if($vendor['option_9_format'] == 'editor')
                $Tab10 .= $PHPShopGUI->setCollapse($vendor['option_9_name'], setModOptionGUI("option9_new", $vendor['option_9_format'], $data['option9']), 'in', false);
            else

...
function actionStart() {
    ...
    $PHPShopInterface->setCaption(array("Дата","10%"),array("IP","10%"),array("Ошибка","80%"));
    ...
    if(count($data)>5)$PHPShopInterface->_CODE_ADD_BUTTON=$PHPShopInterface->setInput("button","","Выгрузить в CSV","right",150,"return  window.open('".$link."','_blank');","but");

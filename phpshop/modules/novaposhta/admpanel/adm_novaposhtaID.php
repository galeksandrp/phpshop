...
function actionStart() {
    ...
    // Выборка
    $data = $PHPShopOrm->getOne(array('*'), array('id' => '=' . (int) $_GET['id']));
    ...
    $Tab1 = $PHPShopGUI->setTextarea(null, $log, $float = "none", $width = '99%', $height = '550');

    // Вывод формы закладки
    $PHPShopGUI->setTab(array("Информация", $Tab1));

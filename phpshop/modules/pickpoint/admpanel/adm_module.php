...
function actionStart() {
    ...
    $info='Необходимо создать новую доставку с именем \'Пункты выдачи товара PickPoint\'. Если имя доcтавки требуется изменить, то
        новое имя нужно указать в настройках этого модуля в поле \'Имя доставка PickPoint\'.
<p>

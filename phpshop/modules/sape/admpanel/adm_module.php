...
При включении опции "Вывод блока на сайте" Sape ссылки будут автомаически добавлены в левый или правый текстовый блок  в конец списка.

Для произвольного включения формы вывода ссылок нужно снять галочку "Вывод блока на сайте" и в вставить перемнную @sape@
в нужное место шаблонов index.tpl и shop.tpl.

Для размещения в текстовых блоках черех админ-панель следует отключить визуальный редактор через настройку системы, создть новый тестовый блок, отключить опцию "вывод блока на сайте" и вставить код:

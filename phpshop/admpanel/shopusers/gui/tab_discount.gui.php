...
function tab_discount($cumulative_discount) {
    ...
    $disp = "<table class='table table-striped'>
            ...
            . $cumulative_html
            . "<tr>"
            . "<td>" . $PHPShopGUI->setInputText(false, 'cumulative_sum_ot['.($key+1).']', null, "200") . "</td>"
            . "<td>" . $PHPShopGUI->setInputText(false, 'cumulative_sum_do['.($key+1).']', null, "200") . "</td>"
            ...
            . "</tr>"
            . "<tr>"
            . "<td>" . $PHPShopGUI->setInputText(false, 'cumulative_sum_ot['.($key+2).']', null, "200") . "</td>"
            . "<td>" . $PHPShopGUI->setInputText(false, 'cumulative_sum_do['.($key+2).']', null, "200") . "</td>"
            ...
            . "</tr>"
            . "<tr>"
            . "<td >" . $PHPShopGUI->setInputText(false, 'cumulative_sum_ot['.($key+3).']', null, "200") . "</td>"
            . "<td>" . $PHPShopGUI->setInputText(false, 'cumulative_sum_do['.($key+3).']', null, "200") . "</td>"

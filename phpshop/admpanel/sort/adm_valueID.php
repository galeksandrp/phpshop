                        ...
                        <tr>
                            <td>
                                <FIELDSET>
                                    ...
                                    <div style="padding:10">
                                        <? echo dispPage($page) ?>
                                        <p>* Имя значения характеристики (в таблице характеристик в подробном описании товара) становится ссылкой на указанную страницу с описанием.</p>
                                    </div>
                                </FIELDSET>
                                <? if ($brand) { ?>
                                <FIELDSET>
                                    <LEGEND><span name=txtLang id=txtLang>Иконка значения характеристики</span></LEGEND>
                                    <div style="padding:2">

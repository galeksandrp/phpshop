...
$_SESSION['tinybrowser']['sessioncheck'] = 'idPHPSHOP'; // name of session variable to check
...
$_SESSION['tinybrowser']['language'] = 'ru';
...
$_SESSION['tinybrowser']['path']['root'] = '/UserFiles/'; // upload root directory
$_SESSION['tinybrowser']['path']['image'] = '/UserFiles/Image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$_SESSION['tinybrowser']['path']['media'] = '/UserFiles/Media/'; // Media files location
$_SESSION['tinybrowser']['path']['file'] = '/UserFiles/Files/'; // Other files location
...
// size format: b, kb, mb
$_SESSION['tinybrowser']['maxsize']['image'] = '5000kb'; // Image file maximum size 
$_SESSION['tinybrowser']['maxsize']['media'] = '20mb'; // Media file maximum size 
$_SESSION['tinybrowser']['maxsize']['file'] = '20mb'; // Other file maximum size 
...
$_SESSION['tinybrowser']['pagination'] = 100;
...
$_SESSION['tinybrowser']['window']['width'] = 700;
...
$_SESSION['tinybrowser']['tb_log_error'] = false; // set to true to enable error logging to file
...
$_SESSION['tinybrowser']['error_log_file'] = 'error_' . substr(md5(php_uname()), 0, 10) . '.log';
; // set to different location / file name to hide from sensitive information diggers

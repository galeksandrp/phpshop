...
function actionStart() {
    ...
    $tree = '<table class="table table-hover">
        <tr class="treegrid-all">
           <td><a href="?path=modules" class="treegrid-parent" data-parent="treegrid-all">'.__('Все модули').'</a> <span class="label label-primary pull-right">87</span></td>
	</tr>
       ...
       <tr class="treegrid-credit">
        ...
        <tr class="treegrid-sale">
           <td><a href="?path=modules&cat=sale" class="treegrid-parent" data-parent="treegrid-sale5">'.__('Продажи').'</a> <span class="label label-primary pull-right">11</span></td>
	</tr>

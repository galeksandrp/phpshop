...
function actionStart() {
    ...
    $tree = '<table class="table table-hover">
        <tr class="treegrid-all">
           <td><a href="?path=modules" class="treegrid-parent" data-parent="treegrid-all">'.__('Все модули').'</a> <span id="mod-install-count" class="label label-primary pull-right">88</span></td>
	</tr>
        ...
        <tr class="treegrid-delivery">
           <td><a href="?path=modules&cat=delivery" class="treegrid-parent" data-parent="treegrid-delivery">'.__('Доставка').'</a> <span id="mod-install-count" class="label label-primary pull-right">12</span></td>
	</tr>
       ...
       <tr class="treegrid-credit">
        ...
        <tr class="treegrid-sale">
           <td><a href="?path=modules&cat=sale" class="treegrid-parent" data-parent="treegrid-sale5">'.__('Продажи').'</a> <span id="mod-install-count" class="label label-primary pull-right">7</span></td>
	</tr>

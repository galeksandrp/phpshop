								...
								<tr>
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" >
										<tbody>
											...
											<tr>
												<td align="center" class="heroTitle centerText" style="font-family: Roboto, sans-serif; font-size: 30px; line-height: 30px; font-style: italic; font-weight: 600; letter-spacing: 0px; padding: 0px 0px 20px;" valign="center"><strong><span style="font-weight: normal;">@title@</span></strong></td>
											</tr>
											<tr>

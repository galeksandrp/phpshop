								...
								<tr>
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" class="row" >
										<tbody>
											...
											<tr>
												<td align="center" style="padding:0;padding-bottom: 50px" valign="top"><img alt="Логотип" src="http://@serverPath@@logo@"  style="display:block;border:0;width:160px;" /></td>
											</tr>
											<tr>
											...
											<tr>
												<td align="center" class="heroTitle centerText" style="font-family: Roboto, sans-serif; font-size: 30px; line-height: 30px; font-style: italic; font-weight: 600; letter-spacing: 0px; padding: 0px 0px 20px;" valign="center"><strong><span style="font-weight: normal;">@serverPath@</span></strong></td>
											</tr>
											<tr>
                                    ...
                                    <p>Обновление пароля пользователя @login@</p>

                                        <p>Уважаемый пользователь <b>@login@</b>, Вы запросили обновление пароля  

                ...
                <table width="600" align="center" class="bg2 maint" border="0" cellspacing="0" cellpadding="0" style="background: #fff;">
                    <tr>
                        <td valign="top"><div id="pad1" style="color: #020202; font-size: 14px; padding: 0px 21px 20px;">
                                ...
                                <p>
                                    Через @day@ дней закончится лицензия демо-версии Вашего интернет-магазина @url@. 
                                ...
                                <p>
                                    В случае, если Вы не нашли нужный функционал, рекомендуем <a href="http://phpshop.ru/page/address.html">уточнить</a>  этот вопрос у наших менеджеров 

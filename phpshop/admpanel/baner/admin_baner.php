...
while ($row = mysql_fetch_array($result))
	...
	@$display.="
	<tr onmouseover=\"show_on('r".$id."')\" id=\"r".$id."\" onmouseout=\"show_out('r".$id."')\" class=row onclick=\"miniWin('baner/adm_banerID.php?id=$id',630,510)\">
...
<div align=\"right\" style=\"padding:10\"><BUTTON style=\"width: 15em; height: 2.2em; margin-left:5\"  onclick=\"miniWin('baner/adm_baner_new.php',630,510)\">

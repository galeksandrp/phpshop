...
function tab_menu() {
    ...
    $tree = '
       ...
       <li class="' . $menu_active_statorder . '"><a href="?path=report.statorder">Выручка по заказам</a></li>
       <li class="' . $menu_active_statproduct . '"><a href="?path=report.statproduct">Отчеты по товарам</a></li>    

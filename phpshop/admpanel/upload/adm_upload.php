    ...
    <body bottommargin="0"  topmargin="0" leftmargin="0" rightmargin="0">
            ...
            <table class=mainpage4 cellpadding="5" cellspacing="0" border="0" align="center" width="100%">
                <tr>
                    <td>
                        ...
                        <div id="upload_log" name="upload_log" style="display:block; width:350px; height:200px;background-color:#ffffff; border:1px #CCC black; overflow:auto;"></div><br>
                    ...
                    <td valign="top">
                        ...
                        <button id=upload_button3 name=upload_button3 style="width:120px; margin:5px; " onclick="miniWin('../dumper/dumper.php?upload_action=upload_dump', 500, 430);
        $('upload_button3').style.display = 'none';
        $('upload_button').style.display = 'inline';
        $('dirList2').style.display = 'inline';
        return false;"><span name=txtLang id=txtLang>Выполнить</span></button>
                        ...
                        <div id=dirList2 style="display:none;" >
                            ...
                            <button id=upload_button name=upload_button style="width:120px; margin:5px; " onclick="javascript:upload_go(0);
        return false;"><span name=txtLang id=txtLang>Выполнить</span></button>
                            <br>
                            <br>
                        </div>
                        <div id=dirList_base style="display:none;" >
                            ...
                            <button id=upload_button2 name=upload_button2 style="width:120px; margin:5px; " onclick="miniWin('../dumper/dumper.php?upload_action=upload_backup', 500, 430);
        $('dirList').style.display = 'inline';
        $('upload_button2').style.display = 'none';
        $('upload_button1').style.display = 'inline';
        return false;"><span name=txtLang id=txtLang>Выполнить</span></button>
                            <br>
                            <br>
                        </div>
                        ...
                        <div id=dirList style="display:none;" >
                            ...
                            <button id=upload_button1 name=upload_button1 style="width:120px; margin:5px; " onclick="javascript:upload_go(11);
        return false;"><span name=txtLang id=txtLang>Выполнить</span></button>
                        </div>

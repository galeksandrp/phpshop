...
foreach ($map as $k=>$v) {
	...
	$temp1="";
		if(ftp_site($ftp_stream,"CHMOD ".$SysValue['user_ftp']['chmod']." ".$SysValue['user_ftp']['dir']."/phpshop/inc/config.ini")) $temp1 = " - права проставлены автоматически!";
...
log_write("Был скачан файл обновления базы данных! Выполните ШАГ 2-1 Обновите базу данных (ШАГ 2-1)! Проставьте необходимые права на нижеуказанные папки!");

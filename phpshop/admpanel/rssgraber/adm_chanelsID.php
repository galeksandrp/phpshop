...
// Редактирование записей 
	  ...
	  $id=$row['id'];
	  $link_new = $row['link'];
	  ${"day_num_new".$row['day_num']} = "selected";
...
<input type="text" name="start_date_new" id="start_date_new"  maxlength="10" value="<?php echo $start_date_new?>" style="width:80px;">
<span name=txtLang id=txtLang>по</span>
<input type="text" name="end_date_new"  maxlength="10" value="<?php echo $end_date_new?>" style="width:80px;" >
</div>
</FIELDSET>
	</td>
</tr>

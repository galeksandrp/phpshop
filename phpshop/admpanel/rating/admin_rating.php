...
function Rating() {// Вывод рейтинга
    ...
    while ($row = mysql_fetch_array($result)) {
        ...
        @$display.="
	<tr onmouseover=\"show_on('r" . $id_category . "')\" id=\"r" . $id_category . "\" onmouseout=\"show_out('r" . $id_category . "')\" class=row onclick=\"miniWin('rating/adm_ratingID.php?id=$id_category',650,600)\">

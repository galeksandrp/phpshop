...
while ($row = mysql_fetch_array($result))
	...
	@$display.="
	<tr onmouseover=\"show_on('r".$id."')\" id=\"r".$id."\" onmouseout=\"show_out('r".$id."')\" class=row onclick=\"miniWin('valuta/adm_valutaID.php?id=$id',400,270)\">
...
<div align=\"right\" style=\"width:50%;padding:10\"><BUTTON style=\"width: 15em; height: 2.2em; margin-left:5\"  onclick=\"miniWin('valuta/adm_valuta_new.php',400,350)\">

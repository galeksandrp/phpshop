...
function actionStart() {
    ...
    if (is_array($data)) {
        ...
        $PHPShopInterface->_CODE.= $PHPShopInterface->setAlert('Дополнительные склады не заданы, используется общий основной склад для учета остатков товаров. Дополнительные склады заводятся для учета товаров на разных складах при синхронизации с 1С или на дополнительных витринах.', 'info',true);
    }

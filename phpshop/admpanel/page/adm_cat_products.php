...
global $SysValue;
$sql="select odnotip from ".$SysValue['base']['table_name11']." where id=$n";
...
<script type=\"text/javascript\">
		<!--
		d2 = new dTree('d2');
		d2.add(0,-1,'<b> аталог св€занных товаров</b>');
        ".$dis."
		document.write(d2);
		d2.openAll()
		//-->
...
<div align="center" style="padding:5"><a href="javascript: window.d2.openAll();">открыть все</a> | <a href="javascript: window.d2.closeAll();">закрыть все</a> | <a href="javascript: window.close()">закрыть окно</a></div>

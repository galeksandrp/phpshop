...
function tab_option($data) {
    ...
    $PHPShopInterface->setCaption(array("Иконка", "5%", array('sort' => 'none')), array($parent_title . ' <a class="glyphicon glyphicon glyphicon-cog" href="?path=catalog&id=' . $data['category'] . '&tab=3" title="Изменить" style="cursor:pointer;"></a>', "35%"), array("Цвет", "20%"), array("Кол-во", "10%"), array("Цена", "15%"), array(null, "10%"), array("Вывод", "5%", array('align' => 'right')));

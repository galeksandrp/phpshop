    ...
    var tour = new Tour({
        ...
        steps: [
            ...
            },
            {
                ...
                title: "Наименование",
                content: 'Укажите наименование товара',
                placement: 'top'
            },
            {
            ...
            },
            {
                ...
                title: "Изображение",
                content: 'Откройте кликом папку выбора изображений товара для последующей их загрузки и обработки (изменение размера) на сервере.<p></p> Настройка параметров обработки изображений (маленькая и большая) выполняется в <a href="?path=system#5" target="_blank">Общих настройках</a>',
                placement: 'bottom',
                onNext: function() {
            ...
            },
            {
                ...
                title: "Заголовки",
                content: 'Мета-заголовки необходимы для SEO-оптимизации сайта. Можно выбрать автоматической, шаблонный и ручной режимы настройки для конкретного товара.<p></p> Общая формула генерации мета-заголовков управляется в <a href="?path=system.seo" target="_blank">SEO настройках</a>',
                placement: 'bottom'
            },
            {

...
function tab_menu() {
    ...
    $tree = '
       ...
       <li class="' . $menu_active_restore . '"><a href="?path=update.restore">Восстановление</a></li>
        ...
        $help = '<p class="text-muted">Очень рекомендуется использовать Windows утилиту <a href="http://phpshop.ru/loads/files/setup.exe" target="_blank" class="btn btn-default btn-xs"><span class="glyphicon glyphicon-cloud-download"></span> Updater.exe</a> для работы с обновлениями.</p>';

...
<tr bgcolor="#ffffff">
	<td style="padding:10">
	<b><span name=txtLang id=txtLang>Создание Нового Адреса Рассылки</span></b><br>
...
<input type="text" name="mail" size="68">
</div>
</FIELDSET>
	</td>
</tr>
...
if(isset($editID) and !empty($mail))// Запись редактирования
{

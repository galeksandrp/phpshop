...
<tr>
	<td id="but1"  class="butoff" style="text-align:center;"  onmouseover="ButOn(1)" onmouseout="ButOff(1)" onclick="newfolder();"><img name="imgLang" src="../icon/folder_add.gif" alt="Новый каталог" width="16" height="16" border="0">Создать&nbsp;папку</td>
   <td width="3"></td>
	<td id="but2"  class="butoff" style="text-align:center;"  onmouseover="ButOn(2)" onmouseout="ButOff(2)" onclick="newdelivery();"><img name="imgLang" src="../icon/page_new.gif" alt="Новая позиция" width="16" height="16" border="0">Создать&nbsp;позицию</td>

</tr>
</table>
<?
//Загрузка нужного интерфейса
...
<?
if (isset($id)) {
	$create='Редактирование доставки "'.$city.'"';
} else {
	if ($act=="newdelivery") {
		$create='Создание новой доставки';
		$is_folder=0;
	} else {
		$create='Создание папки доставок';
		$is_folder=1;
	}
}
...
<LEGEND><span name=txtLang id=txtLang><u>Н</u>азвание доставки</span></LEGEND>
...
<LEGEND><span name=txtLang id=txtLang><u>Р</u>одитель доставки</span></LEGEND>
<div style="padding:10">
...
<? }?>
	<input type="button" name="btnLang" class=but value="Отмена" onClick="Cancel();">
	</td>
</tr>
</table>
</form>
<?
} //Если нет ID и действия, не показывать формы

if(isset($newID) and !empty($city_new))// Запись редактирования
{

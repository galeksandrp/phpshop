...
/**
 * Навигация по разделу сортировок
 * @package PHPShopCoreDepricated
 * @return string 
 */
function DispSelectionNav() {
    global $SysValue,$LoadItems;
...
/**
 * Создание SQL запроса на вывож раздела сортировок
 * @package PHPShopCoreDepricated
 * @return string 
 */
function PageSelectionDisp(){
    global $SysValue,$LoadItems;
...
/**
 * Вывод товаров подбора по параметрам
 * @package PHPShopCoreDepricated
 * @return string 
 */

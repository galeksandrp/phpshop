...
/**
 * Реверсивная проверка каталогов страниц
...
function Vivod_map_page() {
    ...
    $dis=" <p><strong><a href=\"/page/CID_1000.html\">Навигация</a></strong></p>";
...
/**
 * Реверсивная проверка каталогов товаров
 * @package PHPShopCoreDepricated
 * @param int $cat ИД каталога
 * @return string
 */
...
function Vivod_map(){
    ...
    $dis.="<p><strong><a href=\"/newtip/\">Акции</a></strong>
<ul>
<li><a href=\"/newtip/\">Новинки</a></li>
<li><a href=\"/spec/\">Спецпредложение</a></li>
<li><a href=\"/newprice/\">Распродажа</a></li>
</ul>
</p>
".Vivod_map_page()."
<p><strong><a href=\"/news/\">Новости</a></strong></p>
<p><strong><a href=\"/links/\">Ссылки</a></strong></p>
";

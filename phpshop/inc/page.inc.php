...
/**
 * Вывод количества страниц в каталоге
...
/**
 * Вывод содержания каталога страниц
 * @package PHPShopIncDepricated
 * @author PHPShop Software
 * @param Int $category Ид категории
 * @return string
...
/**
 * Вывод товаров однотипов для страниц
 * @package PHPShopIncDepricated
 * @author PHPShop Software
 * @param string $odnotip ид товаров через запятую
 * @return string 
 */
...
/**
 * Вывод списк страниц в каталоге
 * @package PHPShopIncDepricated
 * @author PHPShop Software

 ...
 * @package PHPShopDepricated
 * @param string $from таблица для выборки
 * @param string $sql дополнительное условие
 * @param string $f1 переменная для возврата
 * @return string
 */
...
/**
 * Вывод заголовка для страниц
 * @package PHPShopDepricated
 * @param string $sql допольнительно условие
 * @return array 
 */
